            ...
            <ul className="products__list">
              <li className="products__item">
                <article className="product">
                  <img className="product__image" src="images/photo-2.jpg" alt="Кокосовая матча" />
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__image" src="images/photo-1.jpg" alt="Зеленый индонезийский чай" />
                  <div className="product__content">
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__image" src="images/photo-27.jpg" alt="Черный чай из Эфиопии" />
                  <div className="product__content">
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__image" src="images/photo-5.jpg" alt="Черный чай из Калифорнии" />
                  <div className="product__content">
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__image" src="images/photo-4.jpg" alt="Органическая веганская матча" />
                  <div className="product__content">
              ...
              <li className="products__item">
                <article className="product">
                  <img className="product__image" src="images/photo-3.jpg" alt="Чай черный Лакандона" />
                  <div className="product__content">
